...
domain, created time) in the relational store (db/) and knows how to SEED a
twin's initial graph through the Graph Writer — so a freshly-created twin is
immediately populated and the simulated feed can run against it.
